...
% in: 
%
%   XYZold: 3xN matrix where the columns specify a set of N point
%           coordinates in 3D space
%   
%   deg, u, x0 are the same as in Syntax 1
%
% out:
%
%   XYZnew: The transformation of the columns of XYZold 
%           by the specified rototranslation about the axis.
%   
%   R, T are the same as in Syntax 1
%
%
%
% by Matt Jacobson
