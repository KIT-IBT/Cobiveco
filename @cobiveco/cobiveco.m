% Consistent Biventricular Coordinates X
%
% Usage:
%  c = cobiveco(config);
%  c.computeAll;
...
%    config.CobivecoX:      whether to use CobivecoX or original cobiveco (default: true, CobivecoX is used) [boolean]
%    
%
% Outputs:
...
%
% Written in 2020 by Steffen Schuler, adapted by Lisa Pankewitz in 2022
...
classdef cobiveco < handle
    ...
    properties (SetAccess = private)
        ...
        m1 = struct( ...
         ...
         % Mesh 1 ventricles (isovalue discretization at boundary between LV and RV), ventricular mesh
        m1Ventricles = struct( ...
            'vol', [], ...
            'sur', [], ...
            'surToVol', [], ...
        ...
        m2 = struct( ...
         ...
         % Mesh 2 (isovalue discretization at ridge), ventricular mesh
        m2Ventricles = struct( ...
            'vol', [], ...
            'sur', [], ...
            'surToVol', [], ...
        ...
        % Mesh 2 (isovalue discretization at ridge), RV bridge
        m2RvBridge = struct( ...
            'vol', [], ...
            'sur', [], ...
            'surToVol', [], ...
        ...
        % Mesh 2 (isovalue discretization at ridge), LV bridge
        m2LvBridge = struct( ...
            'vol', [], ...
            'sur', [], ...
            'surToVol', [], ...
    ...
    properties (Access = private)
        ...
        surTv
        surPv
        ventricularmeshRvBoundary
        ventricularmeshLvBoundary
        rvBridgeBoundaryFw
        rvBridgeBoundarySeptum
        lvBridgeBoundaryFw
        lvBridgeBoundarySeptum
        rtLaplaceBridgeLv
        rtLaplaceBridgeRv
        GlvBridge
        GrvBridge
        ...
        available = struct( ...
            ...
            'creategraphandsplitmesh', false, ...
            'rotationalbridges', false, ...
            'apicobasalbridges', false, ...
            'rotationalventricles', false, ...
            'apicobasalventricles', false, ...
            'rotational', false, ...
            'apicobasal', false ...
            );
    ...
    methods
        ...
        function computeAllCobivecoX(o)
            % Compute all coordinates using CobivecoX 
            t = toc;
            ...
            o.computeRotationalVentricles;
            o.computeApicobasalVentricles;
            o.exportResult;
        ...
        function computeAllCobiveco(o)
            % Compute all coordinates using Cobiveco
            t = toc;
            o.computeTransventricular;
            o.prepareMesh1;
            o.computeTransmural;
